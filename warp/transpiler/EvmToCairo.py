...
class EvmToCairo:
        ...
        self.text_segments.append(
            "\n".join(
                [
                    ...
                    f"(stack : StackItem*, calldata : felt*, calldata_size) -> "
    ...
    def construct_run_from_function(self):
        run_from = [
            ...
            "(evm_pc: Uint256, stack: StackItem*, calldata : felt*, calldata_size) -> (stack: StackItem*, output: Output):"
        ]
    ...
    def __make_main(self):
        header = """
@external
func main{storage_ptr : Storage*, pedersen_ptr : HashBuiltin*, range_check_ptr}(calldata_len, calldata : felt*, calldata_size):"""
