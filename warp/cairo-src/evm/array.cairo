...
from evm.memory import read_uint128 as memory_read_uint128, write_uint128 as memory_write_uint128
...
func copy_to_memory{memory_dict : DictAccess*, range_check_ptr}(
    ...
    if res == 1:
        ...
        return copy_to_memory(
            array_length, array, array_offset + 16, memory_offset + 16, length - 16)
    end
end

func aload{range_check_ptr}(array_length : felt, array : felt*, offset) -> (value : Uint256):
    alloc_locals
...
func read_uint128{range_check_ptr}(array_length, array : felt*, offset) -> (res):
    alloc_locals
