...
class ToCairoVisitor(AstVisitor):
    ...
    #         # We need these functions to be generated by default
    #         self.cairo_functions.bigstruct(128)
    #         self.cairo_functions.bigstructencode_function(128)
    #         self.cairo_functions.bigstructdecode_function(128)
