...
func __warp_cond_revert(_4_73 : Uint256) -> ():
    alloc_locals
    if _4_73.low + _4_73.high != 0:
        assert 0 = 1
        jmp rel 0
    else:
        return ()
...
func validator_revert_address{range_check_ptr}(value_69 : Uint256) -> ():
    alloc_locals
    ...
    local range_check_ptr = range_check_ptr
    let (local _2_71 : Uint256) = uint256_and(value_69, _1_70)
    local range_check_ptr = range_check_ptr
    let (local _3_72 : Uint256) = is_eq(value_69, _2_71)
    local range_check_ptr = range_check_ptr
    let (local _4_73 : Uint256) = is_zero(_3_72)
    local range_check_ptr = range_check_ptr
    __warp_cond_revert(_4_73)
    return ()
end
...
func abi_decode_tuple_address{exec_env : ExecutionEnvironment, range_check_ptr}(
    ...
    alloc_locals
    local _1_3 : Uint256 = Uint256(low=32, high=0)
...
func abi_encode_rational_by_to_uint256{memory_dict : DictAccess*, msize, range_check_ptr}(
        value_15 : Uint256, pos_16 : Uint256) -> ():
    alloc_locals
    mstore_(offset=pos_16.low, value=value_15)
...
func abi_encode_rational_by{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    let (local tail_22 : Uint256) = u256_add(headStart_20, _1_23)
    local range_check_ptr = range_check_ptr
    abi_encode_rational_by_to_uint256(value0_21, headStart_20)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    return (tail_22)
...
func finalize_allocation{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    mstore_(offset=_9_32.low, value=newFreePtr)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    return ()
...
func validator_revert_bool{range_check_ptr}(value_76 : Uint256) -> ():
    alloc_locals
    let (local _1_77 : Uint256) = is_zero(value_76)
    local range_check_ptr = range_check_ptr
    let (local _2_78 : Uint256) = is_zero(_1_77)
    local range_check_ptr = range_check_ptr
    let (local _3_79 : Uint256) = is_eq(value_76, _2_78)
    local range_check_ptr = range_check_ptr
    let (local _4_80 : Uint256) = is_zero(_3_79)
    local range_check_ptr = range_check_ptr
    __warp_cond_revert(_4_80)
    return ()
end
...
func abi_decode_bool_fromMemory{memory_dict : DictAccess*, msize, range_check_ptr}(
        headStart_6 : Uint256, dataEnd_7 : Uint256) -> (value0_8 : Uint256):
    alloc_locals
    local _1_9 : Uint256 = Uint256(low=32, high=0)
    let (local _2_10 : Uint256) = uint256_sub(dataEnd_7, headStart_6)
    local range_check_ptr = range_check_ptr
    let (local _3_11 : Uint256) = slt(_2_10, _1_9)
    local range_check_ptr = range_check_ptr
    __warp_cond_revert(_3_11)
    let (local value0_8 : Uint256) = abi_decode_t_bool_fromMemory(headStart_6)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    return (value0_8)
...
func __warp_block_0{
        ...
        _6_36 : Uint256) -> (expr : Uint256):
    alloc_locals
    let (local _17_47 : Uint256) = __warp_identity_Uint256(
        Uint256(low=exec_env.returndata_size, high=0))
    local exec_env : ExecutionEnvironment = exec_env
    finalize_allocation(_6_36, _17_47)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local _18_48 : Uint256) = __warp_identity_Uint256(
        Uint256(low=exec_env.returndata_size, high=0))
    local exec_env : ExecutionEnvironment = exec_env
    let (local _19_49 : Uint256) = u256_add(_6_36, _18_48)
    local range_check_ptr = range_check_ptr
    let (local expr : Uint256) = abi_decode_bool_fromMemory(_6_36, _19_49)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    return (expr)
...
func __warp_if_0{
        exec_env : ExecutionEnvironment, memory_dict : DictAccess*, msize, range_check_ptr}(
        _15_45 : Uint256, _6_36 : Uint256, expr : Uint256) -> (expr : Uint256):
    alloc_locals
    if _15_45.low + _15_45.high != 0:
        let (local expr : Uint256) = __warp_block_0(_6_36)
        local exec_env : ExecutionEnvironment = exec_env
        local memory_dict : DictAccess* = memory_dict
        local msize = msize
        local range_check_ptr = range_check_ptr
...
func fun_callMe{
    ...
    let (local __warp_subexpr_0 : Uint256) = uint256_shl(
        Uint256(low=160, high=0), Uint256(low=1, high=0))
    local range_check_ptr = range_check_ptr
    let (local _1_33 : Uint256) = uint256_sub(__warp_subexpr_0, Uint256(low=1, high=0))
    local range_check_ptr = range_check_ptr
    let (local _2_34 : Uint256) = uint256_and(var_add, _1_33)
    local range_check_ptr = range_check_ptr
    local _5_35 : Uint256 = Uint256(low=64, high=0)
    let (local _6_36 : Uint256) = mload_(_5_35.low)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local _7_37 : Uint256) = uint256_shl(
        Uint256(low=227, high=0), Uint256(low=243012307, high=0))
    local range_check_ptr = range_check_ptr
    mstore_(offset=_6_36.low, value=_7_37)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    local _8_38 : Uint256 = Uint256(low=32, high=0)
    local _9_39 : Uint256 = Uint256(low=66, high=0)
    local _10_40 : Uint256 = Uint256(low=4, high=0)
    let (local _11_41 : Uint256) = u256_add(_6_36, _10_40)
    local range_check_ptr = range_check_ptr
    let (local _12_42 : Uint256) = abi_encode_rational_by(_11_41, _9_39)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local _13_43 : Uint256) = uint256_sub(_12_42, _6_36)
    local range_check_ptr = range_check_ptr
    let (local _14_44 : Uint256) = gas()
    local range_check_ptr = range_check_ptr
    let (local _15_45 : Uint256) = warp_static_call(_14_44, _2_34, _6_36, _13_43, _6_36, _8_38)
    local syscall_ptr : felt* = syscall_ptr
    local storage_ptr : Storage* = storage_ptr
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
    local range_check_ptr = range_check_ptr
    let (local _16_46 : Uint256) = is_zero(_15_45)
    local range_check_ptr = range_check_ptr
    __warp_cond_revert(_16_46)
    local expr : Uint256 = Uint256(low=0, high=0)
    let (local expr : Uint256) = __warp_if_0(_15_45, _6_36, expr)
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
...
func abi_encode_bool_to_bool{memory_dict : DictAccess*, msize, range_check_ptr}(
        value_12 : Uint256, pos : Uint256) -> ():
    alloc_locals
    let (local _1_13 : Uint256) = is_zero(value_12)
    local range_check_ptr = range_check_ptr
    let (local _2_14 : Uint256) = is_zero(_1_13)
    local range_check_ptr = range_check_ptr
    mstore_(offset=pos.low, value=_2_14)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    return ()
...
func abi_encode_bool{memory_dict : DictAccess*, msize, range_check_ptr}(
        headStart_17 : Uint256, value0_18 : Uint256) -> (tail : Uint256):
    alloc_locals
    local _1_19 : Uint256 = Uint256(low=32, high=0)
    let (local tail : Uint256) = u256_add(headStart_17, _1_19)
    local range_check_ptr = range_check_ptr
    abi_encode_bool_to_bool(value0_18, headStart_17)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    return (tail)
...
func __warp_block_2{
    ...
    let (local _16 : Uint256) = abi_decode_tuple_address(_3, _4)
    local exec_env : ExecutionEnvironment = exec_env
    local range_check_ptr = range_check_ptr
    local exec_env : ExecutionEnvironment = exec_env
