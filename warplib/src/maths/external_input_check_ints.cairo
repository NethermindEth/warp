...
func warp_external_input_check_int232{range_check_ptr}(x : felt){
    let inRange : felt = is_le_felt(x, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
...
func warp_external_input_check_int240{range_check_ptr}(x : felt){
    let inRange : felt = is_le_felt(x, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
...
func warp_external_input_check_int248{range_check_ptr}(x : felt){
    let inRange : felt = is_le_felt(x, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
...
func warp_external_input_check_int256{range_check_ptr}(x : Uint256){
    ...
    with_attr error_message("Error: value out-of-bounds. Values passed to high and low members of Uint256 must be less than 2**128."){
