...
impl ByteAccessorImpl of ByteAccessorTrait {

    fn byte256_at_index(base: u256, index: felt252) -> felt252 {
        let index256 = u256_from_felt252(index);
        if index256 >= u256_from_felt252(32) {
            panic_with_felt252('index > 31 for u256 byte access');
        }
        // let value256 = base & ();
        return 0;
    }
