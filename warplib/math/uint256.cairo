...
# TODO implement this and unsafe_u256_sub differently
func u256_sub{range_check_ptr}(x : Uint256, y : Uint256) -> (result : Uint256):
    return uint256_sub(x, y)
end

# TODO produce correct version of this (currently temporary)
func unsafe_u256_sub{range_check_ptr}(x : Uint256, y : Uint256) -> (result : Uint256):
    return uint256_sub(x, y)
end
...
func u256_eq{range_check_ptr}(op1 : Uint256, op2 : Uint256) -> (result : felt):
    return uint256_eq(op1, op2)
end
...
func u256_lt{range_check_ptr}(op1 : Uint256, op2 : Uint256) -> (result : felt):
...
func u256_high(in : Uint256) -> (high : felt):
    return (in.high)
end
...
# # TODO makes these types match
# func u256_is_gte{range_check_ptr}(op1 : Uint256, op2 : Uint256) -> (result: felt):
