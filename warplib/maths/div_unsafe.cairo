...
func warp_div_unsafe8{range_check_ptr}(lhs : Uint8, rhs : Uint8) -> (res : Uint8):
    if rhs.value == 0:
...
func warp_div_unsafe16{range_check_ptr}(lhs : Uint16, rhs : Uint16) -> (res : Uint16):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe24{range_check_ptr}(lhs : Uint24, rhs : Uint24) -> (res : Uint24):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe32{range_check_ptr}(lhs : Uint32, rhs : Uint32) -> (res : Uint32):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe40{range_check_ptr}(lhs : Uint40, rhs : Uint40) -> (res : Uint40):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe48{range_check_ptr}(lhs : Uint48, rhs : Uint48) -> (res : Uint48):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe56{range_check_ptr}(lhs : Uint56, rhs : Uint56) -> (res : Uint56):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe64{range_check_ptr}(lhs : Uint64, rhs : Uint64) -> (res : Uint64):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe72{range_check_ptr}(lhs : Uint72, rhs : Uint72) -> (res : Uint72):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe80{range_check_ptr}(lhs : Uint80, rhs : Uint80) -> (res : Uint80):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe88{range_check_ptr}(lhs : Uint88, rhs : Uint88) -> (res : Uint88):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe96{range_check_ptr}(lhs : Uint96, rhs : Uint96) -> (res : Uint96):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe104{range_check_ptr}(lhs : Uint104, rhs : Uint104) -> (res : Uint104):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe112{range_check_ptr}(lhs : Uint112, rhs : Uint112) -> (res : Uint112):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe120{range_check_ptr}(lhs : Uint120, rhs : Uint120) -> (res : Uint120):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe128{range_check_ptr}(lhs : Uint128, rhs : Uint128) -> (res : Uint128):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe136{range_check_ptr}(lhs : Uint136, rhs : Uint136) -> (res : Uint136):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe144{range_check_ptr}(lhs : Uint144, rhs : Uint144) -> (res : Uint144):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe152{range_check_ptr}(lhs : Uint152, rhs : Uint152) -> (res : Uint152):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe160{range_check_ptr}(lhs : Uint160, rhs : Uint160) -> (res : Uint160):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe168{range_check_ptr}(lhs : Uint168, rhs : Uint168) -> (res : Uint168):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe176{range_check_ptr}(lhs : Uint176, rhs : Uint176) -> (res : Uint176):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe184{range_check_ptr}(lhs : Uint184, rhs : Uint184) -> (res : Uint184):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe192{range_check_ptr}(lhs : Uint192, rhs : Uint192) -> (res : Uint192):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe200{range_check_ptr}(lhs : Uint200, rhs : Uint200) -> (res : Uint200):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe208{range_check_ptr}(lhs : Uint208, rhs : Uint208) -> (res : Uint208):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe216{range_check_ptr}(lhs : Uint216, rhs : Uint216) -> (res : Uint216):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe224{range_check_ptr}(lhs : Uint224, rhs : Uint224) -> (res : Uint224):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe232{range_check_ptr}(lhs : Uint232, rhs : Uint232) -> (res : Uint232):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe240{range_check_ptr}(lhs : Uint240, rhs : Uint240) -> (res : Uint240):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
...
func warp_div_unsafe248{range_check_ptr}(lhs : Uint248, rhs : Uint248) -> (res : Uint248):
    if rhs.value == 0:
        with_attr error_message("Division by zero error"):
            assert 1 = 0
        end
