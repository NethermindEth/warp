...
func byte_at_index_uint256{ bitwise_ptr : BitwiseBuiltin*, range_check_ptr}(base : felt, index : Uint256 ) -> (res : felt):
    alloc_locals
...
func byte_at_index{ bitwise_ptr : BitwiseBuiltin*, range_check_ptr}(base : felt, index : felt ) -> (res : felt):
    alloc_locals
