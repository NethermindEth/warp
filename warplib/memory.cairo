...
func wm_index_static{range_check_ptr}(arrayLoc: felt, index: Uint256, width: Uint256, length: Uint256) -> (loc: felt):
...
func wm_index_dyn{range_check_ptr, warp_memory: DictAccess*}(arrayLoc: felt, index: Uint256, width: Uint256) -> (loc: felt):
    alloc_locals
...
func wm_new{range_check_ptr, warp_memory: DictAccess*}(len: Uint256, elemWidth: Uint256) -> (loc: felt):
    alloc_locals
