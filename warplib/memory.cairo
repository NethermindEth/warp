...
func warp_idx{range_check_ptr}(arrayIndex: Uint256, width: felt, offset: felt) -> (feltIndex: Uint256):
...
func warp_memory_read{range_check_ptr}(warp_memory: MemCell*, name: felt, offset: Uint256) -> (res: felt):
...
func _at_current_cell{range_check_ptr}(warp_memory: MemCell*, name: felt, offset: Uint256) -> (res: felt):
...
func _init_arr{range_check_ptr, warp_memory: MemCell*}(name: felt, len: Uint256, curr: Uint256) -> ():
