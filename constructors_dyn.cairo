...
func memory_array_index_access_uint256{range_check_ptr}(baseRef : Uint256, index : Uint256) -> (
        addr : Uint256):
    alloc_locals
    local _1_85 : Uint256 = Uint256(low=3, high=0)
    let (local _2_86 : Uint256) = is_lt(index, _1_85)
    local range_check_ptr = range_check_ptr
    let (local _3_87 : Uint256) = is_zero(_2_86)
    local range_check_ptr = range_check_ptr
    __warp_cond_revert(_3_87)
    local _4_88 : Uint256 = Uint256(low=5, high=0)
    let (local _5_89 : Uint256) = u256_shl(_4_88, index)
    local range_check_ptr = range_check_ptr
    let (local addr : Uint256) = u256_add(baseRef, _5_89)
    local range_check_ptr = range_check_ptr
    return (addr)
end
...
func read_from_memoryt_uint256{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    alloc_locals
    let (local _1_108 : Uint256) = mload_(ptr.low)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local returnValue : Uint256) = cleanup_uint256(_1_108)
    return (returnValue)
end
...
func setter_fun_ownerCellNumber{pedersen_ptr : HashBuiltin*, range_check_ptr, syscall_ptr : felt*}(
        value_126 : Uint256) -> ():
    alloc_locals
    ownerCellNumber.write(value_126)
    return ()
end
...
func fun_warp_ctorHelper_DynArgs{
    ...
    let (local _1_73 : Uint256) = mload_(var_ownerAge_mpos.low)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local _2_74 : Uint256) = cleanup_uint256(_1_73)
    local _3_75 : Uint256 = Uint256(low=0, high=0)
    let (local _4_76 : Uint256) = memory_array_index_access_uint256(var_rando_mpos, _3_75)
    local range_check_ptr = range_check_ptr
    let (local _5_77 : Uint256) = read_from_memoryt_uint256(_4_76)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local _6_78 : Uint256) = checked_add_uint256(_2_74, _5_77)
    local range_check_ptr = range_check_ptr
    setter_fun_ownerAge(_6_78)
    local pedersen_ptr : HashBuiltin* = pedersen_ptr
    local range_check_ptr = range_check_ptr
    local syscall_ptr : felt* = syscall_ptr
...
func __warp_block_5{
    ...
    let (local param : Uint256, local param_1 : Uint256, local param_2 : Uint256,
        local param_3 : Uint256) = abi_decode_addresst_struct_Persont_uint256t_array_uint256(_3, _4)
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    ...
    local range_check_ptr = range_check_ptr
    local syscall_ptr : felt* = syscall_ptr
    local _23 : Uint256 = _7
    local _24 : Uint256 = _2
    let (local _25 : Uint256) = mload_(_2.low)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
...
func __warp_block_8{
    ...
    local range_check_ptr = range_check_ptr
    __warp_if_4(_2, _3, _4, __warp_subexpr_0)
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local pedersen_ptr : HashBuiltin* = pedersen_ptr
...
func __warp_block_6{
    ...
    local range_check_ptr = range_check_ptr
    __warp_if_3(_2, _3, _4, __warp_subexpr_0, match_var)
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local pedersen_ptr : HashBuiltin* = pedersen_ptr
...
func __warp_if_2{
        exec_env : ExecutionEnvironment, memory_dict : DictAccess*, msize,
        pedersen_ptr : HashBuiltin*, range_check_ptr, syscall_ptr : felt*}(
        _2 : Uint256, _3 : Uint256, _4 : Uint256, _7 : Uint256, __warp_subexpr_0 : Uint256,
        match_var : Uint256) -> ():
    alloc_locals
    if __warp_subexpr_0.low + __warp_subexpr_0.high != 0:
        __warp_block_5(_2, _3, _4, _7)
        local exec_env : ExecutionEnvironment = exec_env
        local memory_dict : DictAccess* = memory_dict
        local msize = msize
        local pedersen_ptr : HashBuiltin* = pedersen_ptr
...
func __warp_block_4{
        exec_env : ExecutionEnvironment, memory_dict : DictAccess*, msize,
        pedersen_ptr : HashBuiltin*, range_check_ptr, syscall_ptr : felt*}(
        _2 : Uint256, _3 : Uint256, _4 : Uint256, _7 : Uint256, match_var : Uint256) -> ():
    alloc_locals
    let (local __warp_subexpr_0 : Uint256) = is_eq(match_var, Uint256(low=2048928276, high=0))
    local range_check_ptr = range_check_ptr
    __warp_if_2(_2, _3, _4, _7, __warp_subexpr_0, match_var)
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local pedersen_ptr : HashBuiltin* = pedersen_ptr
...
func __warp_if_1{
    ...
    if __warp_subexpr_0.low + __warp_subexpr_0.high != 0:
        ...
        __warp_block_4(_2, _3, _4, _7, match_var)
        local exec_env : ExecutionEnvironment = exec_env
        local memory_dict : DictAccess* = memory_dict
        local msize = msize
        local pedersen_ptr : HashBuiltin* = pedersen_ptr
...
func __warp_block_2{
    ...
    local range_check_ptr = range_check_ptr
    __warp_if_1(_1, _2, _3, _4, _7, __warp_subexpr_0, match_var)
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local pedersen_ptr : HashBuiltin* = pedersen_ptr
...
func __warp_block_1{
    ...
    __warp_block_2(_1, _2, _3, _4, _7, match_var)
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local pedersen_ptr : HashBuiltin* = pedersen_ptr
...
func __warp_block_0{
    ...
    local range_check_ptr = range_check_ptr
    __warp_block_1(_1, _10, _2, _3, _4, _7)
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local pedersen_ptr : HashBuiltin* = pedersen_ptr
