...
> **Note:**
> Executing Warp using Docker works only for x86 architecture. If you're using ARM architecture (such as Apple's M1) you can find manual installation instructions [below](https://nethermindeth.github.io/warp/docs/contribution_guidelines/setuping-development-environment#manually).
