...
The following example demonstrates a ContractFactory that deploys ContractA.

![Contract Factories FlowChart](https://cdn-images-1.medium.com/max/800/1*rn1dlgKlpfLv9ng0JvpPkQ.png)
