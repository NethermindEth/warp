...
For more detailed and implemented steps, you can look at the [interfaceForwarder.test.ts](https://github.com/NethermindEth/warp/blob/develop/tests/interfaceCallForwarder/interfaceForwarder.test.ts) file.
