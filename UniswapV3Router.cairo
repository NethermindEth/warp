...
func __warp_if_2{exec_env : ExecutionEnvironment, range_check_ptr}(
        _3_810 : Uint256, var_recipient : Uint256) -> (var_recipient : Uint256):
    alloc_locals
    if _3_810.low + _3_810.high != 0:
        let (local var_recipient : Uint256) = address()
        local range_check_ptr = range_check_ptr
...
func fun_exactInputInternal{
    ...
    let (local _33_839 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
    let (local _34_840 : Uint256) = warp_call(
        _33_839, expr_3008_address, _32_838, _25_831, _31_837, _25_831, _15_823)
    local syscall_ptr : felt* = syscall_ptr
    local storage_ptr : Storage* = storage_ptr
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
...
func __warp_if_7{exec_env : ExecutionEnvironment, range_check_ptr}(
        __warp_subexpr_1 : Uint256, var_recipient_911 : Uint256) -> (var_recipient_911 : Uint256):
    alloc_locals
    if __warp_subexpr_1.low + __warp_subexpr_1.high != 0:
        let (local var_recipient_911 : Uint256) = address()
        local range_check_ptr = range_check_ptr
...
func fun_exactOutputInternal{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local _10_929 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_12 : Uint256) = uint256_sub(_9_928, _8_927)
    local range_check_ptr = range_check_ptr
    let (local _11_930 : Uint256) = warp_call(
        _10_929,
        expr_3233_address,
...
func zero_memory_chunk_bytes1{
    ...
    alloc_locals
    let (local _1_1767 : Uint256) = __warp__id(Uint256(exec_env.calldata_size, 0))
...
func fun_safeTransferETH{
    ...
    local range_check_ptr = range_check_ptr
    let (local _7_1110 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
    let (local expr_component_1111 : Uint256) = warp_call(
        _7_1110, var_to, var_value_1103, _6_1109, _4_1107, _1_1104, _1_1104)
    local syscall_ptr : felt* = syscall_ptr
    local storage_ptr : Storage* = storage_ptr
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
...
func __warp_if_14{
        exec_env : ExecutionEnvironment, memory_dict : DictAccess*, msize, range_check_ptr,
        storage_ptr : Storage*, syscall_ptr : felt*}(_3_1100 : Uint256) -> ():
    alloc_locals
...
func fun_selfPermitAllowed{
    ...
    let (local _10_1202 : Uint256) = address()
    local range_check_ptr = range_check_ptr
    ...
    let (local _17_1209 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
    let (local _18_1210 : Uint256) = warp_call(
        _17_1209, _2_1196, _8_1200, _6_1198, _15_1207, _6_1198, _8_1200)
    local syscall_ptr : felt* = syscall_ptr
    local storage_ptr : Storage* = storage_ptr
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
...
func access_calldata_tail_bytes_calldata{exec_env : ExecutionEnvironment, range_check_ptr}(
    ...
    local range_check_ptr = range_check_ptr
    let (local _2_582 : Uint256) = __warp__id(Uint256(exec_env.calldata_size, 0))
...
func fun_exactOutput_dynArgs_inner{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local _4_980 : Uint256) = __warp__id(Uint256(exec_env.calldata_size, 0))
...
func __warp_block_29{
    ...
    let (local _37_1520 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
    let (local _38_1521 : Uint256) = warp_call(
        _37_1520, expr_1618_address, _31_1514, _29_1512, _35_1518, _29_1512, _31_1514)
    local syscall_ptr : felt* = syscall_ptr
    local storage_ptr : Storage* = storage_ptr
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
...
func fun_unwrapWETH9{
    ...
    let (local _9_1493 : Uint256) = address()
    local range_check_ptr = range_check_ptr
    ...
    local range_check_ptr = range_check_ptr
    let (local _14_1498 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
...
func __warp_if_20{
    ...
    if __warp_subexpr_0.low + __warp_subexpr_0.high != 0:
        ...
        let (local expr_1_890 : Uint256) = address()
        local range_check_ptr = range_check_ptr
        return (expr_1_890)
    end
end
...
func __warp_block_41{
    ...
    alloc_locals
    let (local var_payer : Uint256) = address()
    local range_check_ptr = range_check_ptr
...
func __warp_loop_2{
    ...
    alloc_locals
    local __warp_break_2 : Uint256 = Uint256(low=0, high=0)
    if Uint256(low=1, high=0).low + Uint256(low=1, high=0).high != 0:
...
func fun_safeTransferFrom{
    ...
    let (local _15_1130 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
    let (local expr_1437_component : Uint256) = warp_call(
        _15_1130, var_token_1113, _11_1126, _3_1118, _13_1128, _11_1126, _11_1126)
    local syscall_ptr : felt* = syscall_ptr
    local storage_ptr : Storage* = storage_ptr
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
...
func fun_safeTransfer{
    ...
    let (local _15_1157 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
    let (local expr_1481_component : Uint256) = warp_call(
        _15_1157, var_token_1140, _11_1153, _3_1145, _13_1155, _11_1153, _11_1153)
    local syscall_ptr : felt* = syscall_ptr
    local storage_ptr : Storage* = storage_ptr
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
...
func __warp_block_49{
        ...
        var_token : Uint256, var_value : Uint256) -> ():
    alloc_locals
    let (local _7_1064 : Uint256) = address()
    local range_check_ptr = range_check_ptr
...
func __warp_block_52{
    ...
    let (local _19_1074 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
    let (local _20_1075 : Uint256) = warp_call(
        _19_1074, expr_1724_address, var_value, _15_1070, _18_1073, _15_1070, _17_1072)
    local syscall_ptr : felt* = syscall_ptr
    local storage_ptr : Storage* = storage_ptr
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
    ...
    let (local _38_1091 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
    let (local _39_1092 : Uint256) = warp_call(
        _38_1091, expr_address, _17_1072, _30_1083, _36_1089, _30_1083, _32_1085)
    local syscall_ptr : felt* = syscall_ptr
    local storage_ptr : Storage* = storage_ptr
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
...
func __warp_block_71{
    ...
    let (local _40_1473 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
    let (local _41_1474 : Uint256) = warp_call(
        _40_1473, expr_1847_address, _34_1467, _32_1465, _38_1471, _32_1465, _34_1467)
    local syscall_ptr : felt* = syscall_ptr
    local storage_ptr : Storage* = storage_ptr
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
...
func fun_unwrapWETH9WithFee{
    ...
    let (local _12_1446 : Uint256) = address()
    local range_check_ptr = range_check_ptr
    ...
    local range_check_ptr = range_check_ptr
    let (local _17_1451 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
...
func fun_selfPermitAllowedIfNecessary{
    ...
    let (local _9_1174 : Uint256) = address()
    local range_check_ptr = range_check_ptr
    ...
    local range_check_ptr = range_check_ptr
    let (local _15_1180 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
...
func fun_selfPermit{
    ...
    let (local _9_1252 : Uint256) = address()
    local range_check_ptr = range_check_ptr
    ...
    let (local _16_1259 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
    let (local _17_1260 : Uint256) = warp_call(
        _16_1259, _2_1247, _8_1251, _6_1249, _14_1257, _6_1249, _8_1251)
    local syscall_ptr : felt* = syscall_ptr
    local storage_ptr : Storage* = storage_ptr
    local exec_env : ExecutionEnvironment = exec_env
    local memory_dict : DictAccess* = memory_dict
...
func fun_selfPermitIfNecessary{
    ...
    let (local _9_1226 : Uint256) = address()
    local range_check_ptr = range_check_ptr
    ...
    local range_check_ptr = range_check_ptr
    let (local _15_1232 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
...
func __warp_loop_body_3{
    ...
    local range_check_ptr = range_check_ptr
    let (local _7_1034 : Uint256) = address()
    local range_check_ptr = range_check_ptr
    let (local _8_1035 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
...
func fun_sweepToken{
    ...
    let (local _9_1349 : Uint256) = address()
    local range_check_ptr = range_check_ptr
    ...
    local range_check_ptr = range_check_ptr
    let (local _14_1354 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
...
func fun_sweepTokenWithFee{
    ...
    let (local _12_1318 : Uint256) = address()
    local range_check_ptr = range_check_ptr
    ...
    local range_check_ptr = range_check_ptr
    let (local _17_1323 : Uint256) = __warp__id(Uint256(1, 1))
    local range_check_ptr = range_check_ptr
...
func __warp_block_83{
    ...
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(memPos.low, _14.low)
...
func __warp_block_85{
    ...
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(memPos_1.low, _18.low)
...
func __warp_block_87{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(_20.low, _7.low)
...
func __warp_block_89{
    ...
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(memPos_2.low, _24.low)
...
func __warp_block_91{
    ...
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(memPos_3.low, _28.low)
...
func __warp_block_93{
    ...
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(memPos_4.low, _32.low)
...
func __warp_block_95{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(_34.low, _7.low)
...
func __warp_block_97{
    ...
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(memPos_5.low, _38.low)
...
func __warp_block_99{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(_40.low, _7.low)
...
func __warp_block_101{
    ...
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(memPos_6.low, _44.low)
...
func __warp_block_103{
    ...
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(memPos_7.low, _48.low)
...
func __warp_block_105{
    ...
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(memPos_8.low, _52.low)
...
func __warp_block_107{
    ...
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(memPos_9.low, _56.low)
...
func __warp_block_109{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(_59.low, _7.low)
...
func __warp_block_111{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(_61.low, _7.low)
...
func __warp_block_113{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(_63.low, _7.low)
...
func __warp_block_115{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(_65.low, _7.low)
...
func __warp_block_117{
    ...
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(memPos_10.low, _69.low)
...
func __warp_block_119{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(_72.low, _7.low)
...
func __warp_block_121{
    ...
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(memPos_11.low, _75.low)
...
func __warp_block_123{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(_77.low, _7.low)
...
func __warp_block_125{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(_79.low, _7.low)
...
func __warp_block_127{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local return_ : felt*) = array_create_from_memory(_81.low, _7.low)
...
func fun_ENTRY_POINT{
    ...
    let (local _4 : Uint256) = __warp__id(Uint256(exec_env.calldata_size, 0))
