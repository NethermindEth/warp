    ...
    forAllWidths((width) => {
      if (width === 256) {
        ...
        return [
          ...
          `    if rhs.high == 0:`,
          `        return warp_shr${width}(lhs, rhs.low)`,
          `    else:`,
          `        return (0)`,
          `    end`,
          `end`,
    ...
    forAllWidths((width) => {
      if (width === 256) {
        return [
          ...
          `    if rhs.high == 0:`,
          `        return warp_shr_signed256(lhs, rhs.low)`,
          `    else:`,
          `        return warp_shr_signed256(lhs, 256)`,
          `    end`,
          `end`,
        ];
      } else {
        return [
          ...
          `        return warp_shr${width}(lhs, rhs.low)`,
          `    else:`,
          `        return warp_shr${width}(lhs, ${width})`,
          `    end`,
          `end`,
        ];
      }
