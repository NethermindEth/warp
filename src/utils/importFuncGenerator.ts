...
export function createImport(
  ...
  switch (encodePath([path, name])) {
    ...
    case encodePath(UINT256_SUB):
      return createFuncImport('range_check_ptr');
    case encodePath(U8_OVERFLOW_ADD):
      return createFuncImport();
    case encodePath(U8_OVERFLOW_SUB):
      return createFuncImport();
    case encodePath(U16_OVERFLOW_ADD):
      return createFuncImport();
    case encodePath(U16_OVERFLOW_SUB):
      return createFuncImport();
    case encodePath(U32_OVERFLOW_ADD):
      return createFuncImport();
    case encodePath(U32_OVERFLOW_SUB):
      return createFuncImport();
    case encodePath(U64_OVERFLOW_ADD):
      return createFuncImport();
    case encodePath(U64_OVERFLOW_SUB):
      return createFuncImport();
    case encodePath(U128_OVERFLOW_ADD):
      return createFuncImport();
    case encodePath(U128_OVERFLOW_SUB):
      return createFuncImport();
