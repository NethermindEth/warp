import { toUintOrFelt } from '../utils/utils';
...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c10 = function (head: any, tail: any): any {
    ...
    return (input: Input) => {
      ...
      return [
        ...head(input[0]),
        ...tail.flatMap(([_, __, ___, pf]: [any, any, any, parseF], i: number) => pf(input[i + 1])),
      ];
    };
  };
  const peg$c11 = function (args: any): any {
    return args;
  };
  const peg$c12 = function (t: any, array: any): any {
    return (input: Input) =>
      array.reduce((result: parseF, af: (f: parseF) => parseF) => af(result), t)(input);
  };
  ...
  const peg$c24 = function (width: any): any {
    return (input: Input) => {
      if (input instanceof Array) {
  ...
  const peg$c27 = function (width: any): any {
    return (input: Input) => {
      if (input instanceof Array) {
        error(`Expected input to be number: ${input}`);
        throw 'error already raised, appeasing the typesystem';
  ...
  const peg$c38 = function (len: any): any {
    return (input: Input) => {
      if (input instanceof Array) {
        error(`Expected input to be number: ${input}`);
        throw 'error already raised, appeasing the typesystem';
