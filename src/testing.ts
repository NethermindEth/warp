...
const expectedResults = new Map<string, ResultType>([
  ...
  ['example-contracts/enums7', 'SolCompileFailed'],
  ...
  ['example-contracts/tupleAssignment7', 'SolCompileFailed'],
  ['example-contracts/tupleAssignment8', 'SolCompileFailed'],
  ['example-contracts/typeConversion/explicitTypeConversion', 'SolCompileFailed'],
  ['example-contracts/typeConversion/implicitReturnConversion', 'CairoCompileFailed'],
  ['example-contracts/typeConversion/implicit_type_conv', 'NotSupportedYet'],
