...
const expectedResults = new Map<string, ResultType>(
  [
    ...
    ['example_contracts/naming/event.sol', 'WillNotSupport'],
    ['example_contracts/naming/free_function.sol', 'WillNotSupport'],
    ['example_contracts/naming/function.sol', 'WillNotSupport'],
    ['example_contracts/naming/state_variable.sol', 'WillNotSupport'],
    ['example_contracts/naming/struct.sol', 'WillNotSupport'],
    ['example_contracts/naming/variable.sol', 'WillNotSupport'],
