...
const expectedResults = new Map<string, ResultType>([
  ...
  //
  ['example_contracts/functionInputs/structsTest/StructArrayArray', 'Success'],
  ['example_contracts/functionInputs/structsTest/StructArrayDynArray', 'NotSupportedYet'],
  ['example_contracts/functionInputs/structsTest/StructArrayStruct', 'Success'],
  ['example_contracts/functionInputs/structsTest/StructDynArrayArray', 'NotSupportedYet'],
  ['example_contracts/functionInputs/structsTest/StructDynArrayDynArray', 'NotSupportedYet'],
  ['example_contracts/functionInputs/structsTest/StructDynArrayStruct', 'NotSupportedYet'],
  ['example_contracts/functionInputs/structsTest/StructStructArray', 'Success'],
  ['example_contracts/functionInputs/structsTest/StructStructDynArray', 'NotSupportedYet'],
  ['example_contracts/functionInputs/structsTest/StructStructStruct', 'Success'],
  //
