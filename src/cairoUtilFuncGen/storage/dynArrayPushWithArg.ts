...
export class DynArrayPushWithArgGen extends StringIndexedFuncGen {
  ...
  gen(push: FunctionCall, nodeInSourceUnit?: ASTNode): FunctionCall {
    ...
    const implicits: Implicits[] =
      argLoc === DataLocation.Memory
        ? ['syscall_ptr', 'pedersen_ptr', 'range_check_ptr', 'bitwise_ptr', 'warp_memory']
        : ['syscall_ptr', 'pedersen_ptr', 'bitwise_ptr', 'range_check_ptr'];
  ...
  private getOrCreate(elementType: TypeNode, argType: TypeNode, argLoc: DataLocation): string {
    ...
    const implicits =
      argLoc === DataLocation.Memory
        ? '{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, bitwise_ptr : BitwiseBuiltin*, range_check_ptr : felt, warp_memory: DictAccess*}'
        : '{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, bitwise_ptr : BitwiseBuiltin*, range_check_ptr : felt}';
