...
function update_stack_trace_view() {
  ...
  stack_trace
    .empty()
    .append($('<tr>').append($('<th>').append('fp')).append($('<th>').append('return pc')));
...
function create_stack_trace_row(fp, pc) {
  ...
  const row = $('<tr>').append(fp_cell).append(pc_cell);
...
function create_watch_row() {
  ...
  return $('<tr>').append($('<td>').append(watch_expr)).append($('<td>').append(watch_result));
}
