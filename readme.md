...
To test that your contribution doesn't break any features you can test that all example and tests contracts compile correctly by running the following:
