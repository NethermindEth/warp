...
func __warp_block_1{
    ...
    let (__warp_subexpr_2 : Uint256) = abi_encode_tuple_address(__warp_subexpr_3)
    let (__warp_subexpr_1 : Uint256) = u256_add(
        __warp_subexpr_2,
...
func __warp_block_0{
    ...
    let (__warp_subexpr_0 : Uint256) = is_eq(Uint256(low=952911921, high=0), __warp_subexpr_1)
