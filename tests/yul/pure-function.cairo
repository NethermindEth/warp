...
func __warp_block_0{range_check_ptr}(_3_26 : Uint256, expr : Uint256, var_wad : Uint256) -> (
        var_res : Uint256):
    alloc_locals
    local match_var : Uint256 = _3_26
...
func fun_pureFunction{range_check_ptr}(
    ...
    local range_check_ptr = range_check_ptr
    local _1_24 : Uint256 = Uint256(low=4, high=0)
    let (local _2_25 : Uint256) = uint256_sub(var_res, var_sender)
    local range_check_ptr = range_check_ptr
    let (local _3_26 : Uint256) = is_lt(_2_25, _1_24)
    local range_check_ptr = range_check_ptr
    let (local var_res : Uint256) = __warp_block_0(_3_26, expr, var_wad)
    local range_check_ptr = range_check_ptr
...
@view
func fun_pureFunction_external{
    ...
    with memory_dict, msize:
        let (local var : Uint256) = fun_pureFunction(var_src, var_dst, var_wad, var_sender)
    end
