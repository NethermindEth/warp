...
func __warp_block_0{range_check_ptr}(_3_21 : Uint256, expr : Uint256, var_wad : Uint256) -> (
        var_res : Uint256):
    alloc_locals
    local match_var : Uint256 = _3_21
    let (local var_res : Uint256) = __warp_block_1(expr, match_var, var_wad)
    local range_check_ptr = range_check_ptr
    return (var_res)
end

func fun_pureFunction{range_check_ptr}(
    ...
    local range_check_ptr = range_check_ptr
    local _1_19 : Uint256 = Uint256(low=4, high=0)
    let (local _2_20 : Uint256) = uint256_sub(var_res, var_sender)
    local range_check_ptr = range_check_ptr
    let (local _3_21 : Uint256) = is_lt(_2_20, _1_19)
    local range_check_ptr = range_check_ptr
    let (local var_res : Uint256) = __warp_block_0(_3_21, expr, var_wad)
    local range_check_ptr = range_check_ptr
...
func __warp_block_3{
    ...
    local range_check_ptr = range_check_ptr
    let (local _17 : Uint256) = fun_pureFunction(param, param_1, param_2, param_3)
    local range_check_ptr = range_check_ptr
...
func __warp_block_2{
    ...
    local range_check_ptr = range_check_ptr
    local _11 : Uint256 = Uint256(low=325304746, high=0)
