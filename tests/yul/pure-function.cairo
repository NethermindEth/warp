...
func __warp_if_2{range_check_ptr}(__warp_subexpr_0 : Uint256, expr : Uint256, value2 : Uint256) -> (
        var_res : Uint256):
    alloc_locals
    if __warp_subexpr_0.low + __warp_subexpr_0.high != 0:
...
func __warp_block_3{range_check_ptr}(expr : Uint256, match_var : Uint256, value2 : Uint256) -> (
        var_res : Uint256):
    alloc_locals
...
func __warp_block_2{exec_env : ExecutionEnvironment*, range_check_ptr}(
    ...
    let (__warp_subexpr_0 : Uint256) = uint256_sub(var_res, __warp_subexpr_1)
...
func __warp_block_0{
    ...
    let (__warp_subexpr_0 : Uint256) = is_eq(Uint256(low=325304746, high=0), __warp_subexpr_1)
