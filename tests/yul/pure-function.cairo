...
func __warp_block_3{
    ...
    local exec_env : ExecutionEnvironment* = exec_env
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_3 : Uint256) = fun_pureFunction(param, param_1, param_2, param_3)
    local range_check_ptr = range_check_ptr
...
func __warp_block_2{
    ...
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_0 : Uint256) = is_eq(Uint256(low=325304746, high=0), __warp_subexpr_1)
    local range_check_ptr = range_check_ptr
