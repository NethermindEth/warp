...
func __warp_if_0{range_check_ptr}(__warp_subexpr_0 : Uint256, var_a : Uint256, var_b : Uint256) -> (
        var : Uint256):
    alloc_locals
...
func __warp_block_1{range_check_ptr}(match_var : Uint256, var_a : Uint256, var_b : Uint256) -> (
    ...
    local range_check_ptr = range_check_ptr
    let (local var : Uint256) = __warp_if_0(__warp_subexpr_0, var_a, var_b)
    local range_check_ptr = range_check_ptr
    return (var)
end
...
func __warp_block_0{range_check_ptr}(_1_11 : Uint256, var_a : Uint256, var_b : Uint256) -> (
    ...
    let (local var : Uint256) = __warp_block_1(match_var, var_a, var_b)
    local range_check_ptr = range_check_ptr
    return (var)
end
...
func fun_rando{range_check_ptr}(var_a : Uint256, var_b : Uint256) -> (var : Uint256):
    ...
    local range_check_ptr = range_check_ptr
    let (local var : Uint256) = __warp_block_0(_1_11, var_a, var_b)
    local range_check_ptr = range_check_ptr
    return (var)
end
