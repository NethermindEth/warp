...
func checked_sub_uint256{range_check_ptr}(x_23 : Uint256, y_24 : Uint256) -> (diff : Uint256):
    alloc_locals
...
func checked_add_uint256{range_check_ptr}(x : Uint256, y : Uint256) -> (sum : Uint256):
    alloc_locals
    let (local _1_21 : Uint256) = uint256_not(y)
    local range_check_ptr = range_check_ptr
...
func __warp_loop_body_0{range_check_ptr}(
    ...
    alloc_locals
    let (local _1_26 : Uint256) = is_gt(var_k_1, var_j)
    local range_check_ptr = range_check_ptr
    if _1_26.low + _1_26.high != 0:
        local var : Uint256 = var_k
        local __warp_leave_0 : Uint256 = Uint256(low=1, high=0)
        return (__warp_leave_0, var, var_k_1)
    end
    local _2_27 : Uint256 = Uint256(low=1, high=0)
    let (local var_k_1 : Uint256) = checked_sub_uint256(var_k_1, _2_27)
    local range_check_ptr = range_check_ptr
...
func __warp_block_0{range_check_ptr}(
        __warp_leave_6 : Uint256, var : Uint256, var_i : Uint256, var_j : Uint256, var_k : Uint256,
        var_k_1 : Uint256) -> (__warp_leave_6 : Uint256, var : Uint256, var_k_1 : Uint256):
    alloc_locals
    ...
    local range_check_ptr = range_check_ptr
    if __warp_leave_0.low + __warp_leave_0.high != 0:
        local __warp_leave_6 : Uint256 = Uint256(low=1, high=0)
        return (__warp_leave_6, var, var_k_1)
    else:
        return (__warp_leave_6, var, var_k_1)
    end
end
...
func fun_transferFrom{range_check_ptr}(var_i : Uint256, var_j : Uint256) -> (var : Uint256):
    ...
    local __warp_leave_6 : Uint256 = Uint256(low=0, high=0)
    local var_k : Uint256 = Uint256(low=0, high=0)
    local var_k_1 : Uint256 = var_k
    let (local __warp_leave_6 : Uint256, local var : Uint256,
        local var_k_1 : Uint256) = __warp_block_0(__warp_leave_6, var, var_i, var_j, var_k, var_k_1)
    local range_check_ptr = range_check_ptr
...
func abi_encode_bool_to_bool{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    alloc_locals
    let (local _1_8 : Uint256) = is_zero(value)
    local range_check_ptr = range_check_ptr
    let (local _2_9 : Uint256) = is_zero(_1_8)
    local range_check_ptr = range_check_ptr
    uint256_mstore(offset=pos, value=_2_9)
...
func abi_encode_bool{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    local range_check_ptr = range_check_ptr
    abi_encode_bool_to_bool(value0_11, headStart_10)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    return (tail)
