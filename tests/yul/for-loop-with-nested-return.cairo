...
func __warp_loop_body_0{range_check_ptr}(
    ...
    alloc_locals
    let (local _1_17 : Uint256) = is_gt(var_k_1, var_j)
    local range_check_ptr = range_check_ptr
...
=======
        __warp_leave_6 : Uint256, var : Uint256, var_j : Uint256, var_k : Uint256,
...
=======
    let (local __warp_leave_6 : Uint256, local var : Uint256,
        local var_k_1 : Uint256) = __warp_block_0(__warp_leave_6, var, var_j, var_k, var_k_1)
>>>>>>> staticcall
    local range_check_ptr = range_check_ptr
