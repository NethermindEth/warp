...
func __warp_if_0(_1_11 : Uint256, __warp_break_0 : Uint256) -> (__warp_break_0 : Uint256):
    alloc_locals
...
func __warp_loop_body_0{range_check_ptr}(
    ...
    local range_check_ptr = range_check_ptr
    let (local __warp_break_0 : Uint256) = __warp_if_0(_1_11, __warp_break_0)
...
func __warp_if_1{
    ...
    if __warp_subexpr_0.low + __warp_subexpr_0.high != 0:
        let (local var_k : Uint256) = __warp_block_0(var_i, var_j, var_k)
        local memory_dict : DictAccess* = memory_dict
        local msize = msize
        local pedersen_ptr : HashBuiltin* = pedersen_ptr
        local range_check_ptr = range_check_ptr
...
func __warp_loop_0{
    ...
    local range_check_ptr = range_check_ptr
    let (local var_k : Uint256) = __warp_if_1(__warp_subexpr_0, var_i, var_j, var_k)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local pedersen_ptr : HashBuiltin* = pedersen_ptr
    local range_check_ptr = range_check_ptr
