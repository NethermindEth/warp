...
func __warp_block_1{
    ...
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_3 : Uint256) = fun_viewReturndatasize()
    local exec_env : ExecutionEnvironment* = exec_env
    let (local __warp_subexpr_2 : Uint256) = abi_encode_uint256_66(__warp_subexpr_3)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_1 : Uint256) = u256_add(
...
func __warp_block_0{
    ...
    let (local __warp_subexpr_0 : Uint256) = is_eq(
        Uint256(low=3031022619, high=0), __warp_subexpr_1)
    local range_check_ptr = range_check_ptr
