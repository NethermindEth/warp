...
func allocate_memory{memory_dict : DictAccess*, msize, range_check_ptr}() -> (memPtr_4 : Uint256):
    alloc_locals
    let (local memPtr_4 : Uint256) = uint256_mload(Uint256(low=64, high=0))
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
...
func allocate_memory_array_string{memory_dict : DictAccess*, msize, range_check_ptr}() -> (
        memPtr_5 : Uint256):
    alloc_locals
    let (local memPtr_5 : Uint256) = allocate_memory()
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
...
func copy_literal_to_memory_e1629b9dda060bb30c7908346f6af189c16773fa148d3366701fbaa35d54f3c8{
    ...
    alloc_locals
    let (local memPtr_8 : Uint256) = allocate_memory_array_string()
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_0 : Uint256) = u256_add(memPtr_8, Uint256(low=32, high=0))
    local range_check_ptr = range_check_ptr
...
func array_storeLengthForEncoding_string{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local updated_pos : Uint256) = u256_add(pos, Uint256(low=32, high=0))
    local range_check_ptr = range_check_ptr
    return (updated_pos)
end
...
func __warp_loop_body_0{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    alloc_locals
    let (local __warp_subexpr_2 : Uint256) = u256_add(src, i)
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_1 : Uint256) = uint256_mload(__warp_subexpr_2)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_0 : Uint256) = u256_add(dst, i)
    local range_check_ptr = range_check_ptr
    uint256_mstore(offset=__warp_subexpr_0, value=__warp_subexpr_1)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local i : Uint256) = u256_add(i, Uint256(low=32, high=0))
    local range_check_ptr = range_check_ptr
    return (i)
end
...
func __warp_loop_0{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    alloc_locals
    let (local __warp_subexpr_1 : Uint256) = is_lt(i, length_1)
    local range_check_ptr = range_check_ptr
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local i : Uint256) = __warp_loop_0(dst, i, length_1, src)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    return (i)
...
func __warp_block_0{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    alloc_locals
    let (local __warp_subexpr_0 : Uint256) = u256_add(dst, length_1)
    local range_check_ptr = range_check_ptr
...
func copy_memory_to_memory{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_0 : Uint256) = is_gt(i, length_1)
    local range_check_ptr = range_check_ptr
...
func abi_encode_string_memory_ptr{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    alloc_locals
    let (local length_3 : Uint256) = uint256_mload(value)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local pos_1 : Uint256) = array_storeLengthForEncoding_string(pos_2, length_3)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_0 : Uint256) = u256_add(value, Uint256(low=32, high=0))
    local range_check_ptr = range_check_ptr
...
func abi_encode_string{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_0 : Uint256) = u256_add(headStart, Uint256(low=32, high=0))
    local range_check_ptr = range_check_ptr
    let (local tail : Uint256) = abi_encode_string_memory_ptr(value0, __warp_subexpr_0)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    return (tail)
...
func allocate_and_zero_memory_array_string{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_0 : Uint256) = u256_add(memPtr_9, Uint256(low=32, high=0))
    local range_check_ptr = range_check_ptr
...
func memory_array_index_access_bytes{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    let (local addr : Uint256) = u256_add(baseRef, Uint256(low=32, high=0))
    local range_check_ptr = range_check_ptr
    return (addr)
end
...
func memory_array_index_access_bytes_296{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_1 : Uint256) = is_lt(Uint256(low=1, high=0), __warp_subexpr_2)
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_0 : Uint256) = is_zero(__warp_subexpr_1)
    local range_check_ptr = range_check_ptr
    if __warp_subexpr_0.low + __warp_subexpr_0.high != 0:
    ...
    let (local addr_11 : Uint256) = u256_add(baseRef_10, Uint256(low=33, high=0))
    local range_check_ptr = range_check_ptr
    return (addr_11)
end
...
func memory_array_index_access_bytes_297{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_1 : Uint256) = is_lt(Uint256(low=2, high=0), __warp_subexpr_2)
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_0 : Uint256) = is_zero(__warp_subexpr_1)
    local range_check_ptr = range_check_ptr
    if __warp_subexpr_0.low + __warp_subexpr_0.high != 0:
    ...
    let (local addr_13 : Uint256) = u256_add(baseRef_12, Uint256(low=34, high=0))
    local range_check_ptr = range_check_ptr
    return (addr_13)
end
...
func fun_bytesFun{
        ...
        var_mpos : Uint256):
    alloc_locals
    let (local expr_mpos : Uint256) = allocate_and_zero_memory_array_string()
    local exec_env : ExecutionEnvironment* = exec_env
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
