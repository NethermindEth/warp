...
func convert_bytes32_to_bytes4(value_8 : Uint256) -> (converted : Uint256):
    alloc_locals
    local converted : Uint256 = value_8
    return (converted)
end
...
func fun_callMe{exec_env : ExecutionEnvironment, memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    alloc_locals
    local _1_9 : Uint256 = Uint256(low=4, high=0)
    local _2_10 : Uint256 = Uint256(low=0, high=0)
    local _3_11 : Uint256 = _2_10
    calldatacopy_{range_check_ptr=range_check_ptr, exec_env=exec_env}(_2_10, _2_10, _1_9)
>>>>>>> staticcall
...
=======
    local _4_12 : Uint256 = _2_10
    let (local _5_13 : Uint256) = mload_{
        memory_dict=memory_dict, range_check_ptr=range_check_ptr, msize=msize}(_2_10.low)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    let (local var : Uint256) = convert_bytes32_to_bytes4(_5_13)
>>>>>>> staticcall
    return (var)
end
