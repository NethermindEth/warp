...
func fun_callMe{
    ...
    local msize = msize
    returndata_write(Uint256(low=0, high=0), Uint256(low=4, high=0))
    local exec_env : ExecutionEnvironment* = exec_env
    return (var)
end
...
func __warp_block_1{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local __warp_subexpr_2 : Uint256) = abi_encode_tuple_bytes4(memPos, ret__warp_mangled)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
...
func __warp_block_0{
    ...
    let (local __warp_subexpr_0 : Uint256) = is_eq(
        Uint256(low=2965284645, high=0), __warp_subexpr_1)
    local range_check_ptr = range_check_ptr
