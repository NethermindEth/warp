...
func abi_encode_uint256_to_uint256{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    alloc_locals
    mstore_(offset=pos_14.low, value=value_13)
...
func abi_encode_uint256{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    local range_check_ptr = range_check_ptr
    abi_encode_uint256_to_uint256(value0_19, headStart_18)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    return (tail_20)
...
func abi_encode_tuple_address{memory_dict : DictAccess*, msize, range_check_ptr}(
        headStart_15 : Uint256, value0_16 : Uint256) -> (tail : Uint256):
    alloc_locals
    local _1_17 : Uint256 = Uint256(low=32, high=0)
    let (local tail : Uint256) = u256_add(headStart_15, _1_17)
    local range_check_ptr = range_check_ptr
    abi_encode_address(value0_16, headStart_15)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    return (tail)
...
func __warp_block_5{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local _24 : Uint256) = abi_encode_tuple_address(memPos, ret__warp_mangled)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
...
func __warp_block_7{
    ...
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local _30 : Uint256) = abi_encode_uint256(memPos_1, ret_1)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    let (local _31 : Uint256) = uint256_sub(_30, memPos_1)
    local range_check_ptr = range_check_ptr
    returndata_write(memPos_1, _31)
    local exec_env : ExecutionEnvironment = exec_env
    return ()
end
...
func setter_fun_ownerCellNumber{pedersen_ptr : HashBuiltin*, range_check_ptr, syscall_ptr : felt*}(
        value_39 : Uint256) -> ():
    alloc_locals
    ownerCellNumber.write(value_39)
    return ()
end
