...
namespace WARP:
    ...
    func transfer_a9059cbb{
        ...
        __warp_usrfn0__transfer(__warp_se_7, __warp_usrid10_recipient, __warp_usrid11_amount)
    ...
    func transferFrom_23b872dd{
        ...
        __warp_usrid13_sender : felt,
        __warp_usrid14_recipient : felt,
        __warp_usrid15_amount : Uint256,
    ...
    func __warp_usrfn0__transfer{
        ...
        __warp_usrid17_sender : felt,
        __warp_usrid18_recipient : felt,
        __warp_usrid19_amount : Uint256,
    ) -> ():
        alloc_locals
        ...
        let (__warp_se_11) = warp_sub_unsafe256(__warp_usrid20_senderBalance, __warp_usrid19_amount)
    ...
    func _balances_6ebcf607{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt
    }(__warp_usrid24__i0 : felt) -> (__warp_usrid25_ : Uint256):
        alloc_locals

        warp_external_input_check_address(__warp_usrid24__i0)

        let (__warp_se_16) = WS0_INDEX_felt_to_Uint256(__warp_usrid0__balances, __warp_usrid24__i0)
    ...
    func value_3fa4f245{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt}(
        ...
        let (__warp_se_19) = WS0_READ_Uint256(__warp_usrid2_value)
