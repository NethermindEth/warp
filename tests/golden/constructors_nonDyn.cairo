...
func __constructor_meat{
    ...
    let (__warp_subexpr_2 : Uint256) = slt(__warp_subexpr_3, Uint256(low=96, high=0))
    ...
    let (__warp_subexpr_5 : Uint256) = calldataload(Uint256(low=32, high=0))
    sstore(key=Uint256(low=1, high=0), value=__warp_subexpr_5)
    let (__warp_subexpr_6 : Uint256) = calldataload(Uint256(low=64, high=0))
    sstore(key=Uint256(low=2, high=0), value=__warp_subexpr_6)
    return ()
end
...
func abi_decode_addresst_uint256t_uint256{
...
func __warp_block_4{
    ...
    let (__warp_subexpr_3 : Uint256) = sload(Uint256(low=2, high=0))
...
func __warp_block_6{
    ...
    let (__warp_subexpr_0 : Uint256) = calldatasize()
    abi_decode(__warp_subexpr_0)
    let (ret__warp_mangled : Uint256) = sload(Uint256(low=0, high=0))
