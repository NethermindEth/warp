...
from evm.yul_api import block_number, timestamp, warp_return
...
func __warp_block_3{
        ...
        msize, range_check_ptr, syscall_ptr : felt*, termination_token}(_1 : Uint256) -> ():
    alloc_locals
    ...
    let (__warp_subexpr_3 : Uint256) = block_number()
...
func __warp_block_5{
    ...
    uint256_mstore(offset=memPos, value=__warp_subexpr_3)
...
func __warp_block_4{
    ...
    alloc_locals
    let (__warp_subexpr_0 : Uint256) = is_eq(match_var, Uint256(low=3393824067, high=0))
...
func __warp_block_2{
    ...
    alloc_locals
    let (__warp_subexpr_0 : Uint256) = is_eq(match_var, Uint256(low=1120645468, high=0))
