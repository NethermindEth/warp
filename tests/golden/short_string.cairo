...
func __warp_block_4{
    ...
    let (__warp_subexpr_5 : Uint256) = is_lt(newFreePtr, _1)
    let (__warp_subexpr_4 : Uint256) = is_gt(newFreePtr, Uint256(low=18446744073709551615, high=0))
    let (__warp_subexpr_3 : Uint256) = uint256_or(__warp_subexpr_4, __warp_subexpr_5)
    if __warp_subexpr_3.low + __warp_subexpr_3.high != 0:
        assert 0 = 1
        jmp rel 0
    end
    uint256_mstore(offset=Uint256(low=64, high=0), value=newFreePtr)
    uint256_mstore(offset=_1, value=Uint256(low=3, high=0))
    let (__warp_subexpr_6 : Uint256) = u256_add(_1, Uint256(low=32, high=0))
    uint256_mstore(
        offset=__warp_subexpr_6, value=Uint256(low=0, high=86743870240126275024148876141787086848))
    let (memPos : Uint256) = uint256_mload(Uint256(low=64, high=0))
    let (__warp_subexpr_8 : Uint256) = abi_encode_string(memPos, _1)
...
func __warp_block_6{
    ...
    let (__warp_subexpr_4 : Uint256) = abi_encode_string(memPos_1, ret__warp_mangled)
    let (__warp_subexpr_3 : Uint256) = uint256_sub(__warp_subexpr_4, memPos_1)
    warp_return(memPos_1, __warp_subexpr_3)
    return ()
end
...
func __warp_block_3{
        bitwise_ptr : BitwiseBuiltin*, exec_env : ExecutionEnvironment*, memory_dict : DictAccess*,
        msize, range_check_ptr, termination_token}(_1 : Uint256, match_var : Uint256) -> ():
    alloc_locals
...
func __main_meat{
    ...
    let (__warp_subexpr_0 : Uint256) = is_zero(__warp_subexpr_1)
    __warp_if_3(_1, __warp_subexpr_0)
