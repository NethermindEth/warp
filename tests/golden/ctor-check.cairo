...
func __warp_block_8{
    ...
    alloc_locals
    let (_7 : Uint256) = returndata_size()
    let (__warp_subexpr_0 : Uint256) = is_gt(_7, Uint256(low=18446744073709551615, high=0))
    if __warp_subexpr_0.low + __warp_subexpr_0.high != 0:
        assert 0 = 1
        jmp rel 0
    end
    let (memPtr : Uint256) = uint256_mload(Uint256(low=64, high=0))
    let (__warp_subexpr_4 : Uint256) = u256_add(_7, Uint256(low=31, high=0))
    ...
    uint256_mstore(offset=memPtr, value=_7)
...
func __main_meat{
    ...
    let (_6 : Uint256) = u256_add(_4, __warp_subexpr_4)
    uint256_mstore(offset=_6, value=Uint256(low=0, high=0))
    let (__warp_subexpr_7 : Uint256) = uint256_sub(_6, _4)
