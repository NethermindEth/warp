...
func __constructor_meat{
    ...
    let (__warp_subexpr_1 : Uint256) = uint256_or(__warp_subexpr_2, Uint256(low=18, high=0))
...
func abi_encode_uint256_729{memory_dict : DictAccess*, msize, range_check_ptr}(
...
func fun_withdraw{
        bitwise_ptr : BitwiseBuiltin*, memory_dict : DictAccess*, msize,
        pedersen_ptr : HashBuiltin*, range_check_ptr, syscall_ptr : felt*}(
        var_wad : Uint256, var_sender : Uint256) -> ():
    alloc_locals
...
func fun_get_balance{
        bitwise_ptr : BitwiseBuiltin*, memory_dict : DictAccess*, msize,
        pedersen_ptr : HashBuiltin*, range_check_ptr, syscall_ptr : felt*}(var_src : Uint256) -> (
        var : Uint256):
    alloc_locals
...
func __warp_if_0{
        bitwise_ptr : BitwiseBuiltin*, memory_dict : DictAccess*, msize,
        pedersen_ptr : HashBuiltin*, range_check_ptr, syscall_ptr : felt*}(
        __warp_subexpr_0 : Uint256, var_src : Uint256, var_wad : Uint256) -> ():
    alloc_locals
    if __warp_subexpr_0.low + __warp_subexpr_0.high != 0:
...
func __warp_block_3{
    ...
    let (__warp_subexpr_2 : Uint256) = abi_encode_uint256_729(__warp_subexpr_3)
    let (__warp_subexpr_1 : Uint256) = u256_add(
        __warp_subexpr_2,
