...
//       await expect(safe.addOwnerWithThreshold(user2.address, 1)).to.be.revertedWith(
//         'GS031',
//       );
//     });
...
//       await expect(await safe.getOwners()).to.be.deep.equal([
//         user2.address,
//         user1.address,
//       ]);
//     });
...
//     it('can only be called from Safe itself', async () => {
//       const { safe } = await setupTests();
//       await expect(safe.removeOwner(AddressOne, user2.address, 1)).to.be.revertedWith(
//         'GS031',
//       );
//     });
...
//       const { safe } = await setupTests();
//       await expect(
//         safe.swapOwner(AddressOne, user1.address, user2.address),
...
//           safe,
//           'swapOwner',
//           [AddressOne, user1.address, safe.address],
//           [user1],
//         ),
//       ).to.revertedWith('GS013');
//     });
...
//           safe,
//           'swapOwner',
//           [AddressOne, user1.address, AddressOne],
//           [user1],
//         ),
//       ).to.revertedWith('GS013');
//     });
...
//           safe,
//           'swapOwner',
//           [AddressOne, user1.address, AddressZero],
//           [user1],
//         ),
//       ).to.revertedWith('GS013');
//     });
...
//           safe,
//           'swapOwner',
//           [AddressOne, user1.address, user1.address],
//           [user1],
//         ),
//       ).to.revertedWith('GS013');
//     });
...
//           safe,
//           'swapOwner',
//           [user1.address, AddressOne, user2.address],
//           [user1],
//         ),
//       ).to.revertedWith('GS013');
//     });
...
//           safe,
//           'swapOwner',
//           [user3.address, AddressZero, user2.address],
//           [user1],
//         ),
//       ).to.revertedWith('GS013');
//     });
...
//           safe,
//           'swapOwner',
//           [AddressOne, user3.address, user2.address],
//           [user1],
//         ),
//       ).to.revertedWith('GS013');
//     });
...
//           safe,
//           'swapOwner',
//           [AddressZero, user1.address, user2.address],
//           [user1],
//         ),
//       ).to.revertedWith('GS013');
//     });
...
//           safe,
//           'swapOwner',
//           [AddressOne, user1.address, user2.address],
//           [user1],
//         ),
//       )
//         .to.emit(safe, 'RemovedOwner')
