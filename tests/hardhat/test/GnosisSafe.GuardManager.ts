...
// import { getMock, getSafeWithOwners } from './setup';
// import {
//   buildContractCall,
...
//     const guardEip165Calldata = guardContract.interface.encodeFunctionData(
//       'supportsInterface',
//       ['0xe6d7a83a'],
//     );
...
//         ethers.utils.toUtf8Bytes('guard_manager.guard.address'),
//       );
...
//       const safeTx = buildContractCall(
//         safe,
//         'setGuard',
//         [AddressZero],
//         await safe.nonce(),
...
//       const guardInterface = (await hre.ethers.getContractAt('Guard', mock.address))
//         .interface;
...
//       await expect(executeTx(safe, safeTx, [signature])).to.be.revertedWith(
//         'Computer says Nah',
//       );

//       await mock.reset();

//       await expect(executeTx(safe, safeTx, [signature])).to.emit(
//         safe,
//         'ExecutionSuccess',
//       );

//       expect(await mock.callStatic.invocationCount()).to.be.deep.equals(
//         BigNumber.from(3),
//       );
//       expect(
//         await mock.callStatic.invocationCountForCalldata(checkTxData),
//       ).to.be.deep.equals(BigNumber.from(1));
//       expect(
//         await mock.callStatic.invocationCountForCalldata(checkExecData),
//       ).to.be.deep.equals(BigNumber.from(1));
//       expect(
//         await mock.callStatic.invocationCountForCalldata('0xbaddad42'),
//       ).to.be.deep.equals(BigNumber.from(1));
//     });
