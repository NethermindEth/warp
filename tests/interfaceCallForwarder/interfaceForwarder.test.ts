...
const interfaceSolFile = path.resolve(__dirname, '..', 'interfaceCallForwarder', 'interact.sol');
const interfaceCairoFile = path.resolve(
  __dirname,
  '..',
  'interfaceCallForwarder',
...
const contractJsonPath = path.resolve(__dirname, '..', 'interfaceCallForwarder', 'contract.json');
