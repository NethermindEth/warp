...
contract WARP {
    ...
    constructor() public {
        a[1] = 1;
        b[2] = address(0x0000000000000000000000000000000000000001);
        c[3] = address(0x0000000000000000000000000000000000000001);
        d[true] = 1;
        e[address(0x0000000000000000000000000000000000000001)][1] =
