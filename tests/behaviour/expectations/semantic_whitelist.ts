...
const tests: string[] = [
  ...
  //---------Arithmetics - 25 passing, 16 pending, 7 failing
  // TODO addmod, mulmod compile time
  // TODO addmod, mulmod runtime
  // TODO abi encoder version differences, check int bound checker (checked_add_v2)
  ...[
  ...
  ...[
    //---------Array concat tests: 0 passing, 21 pending, 7 failing - Concat not implemented yet
    ...[
    ...
    ...[
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/array/copying/copy_function_internal_storage_array.sol',
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/array/copying/array_copy_nested_array.sol',
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/array/copying/calldata_dynamic_array_to_memory.sol',
    ...
    //---------Array index access tests: 9 passing, 23 pending, 8 failing, 10 transcodeError
    ...[
    ...
    ...[
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/array/pop/byte_array_pop_isolated.sol',
    ...
    //-------Array push tests: 21 passing, 25 pending, 10 failing, 3 transcodeError
    ...[
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/array/push/array_push_struct_from_calldata.sol',
    ...
    //-------Array misc tests: 53 passing, 108 pending, 43 failing, 1 transcodeError
    ...[
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/array/calldata_array_dynamic_invalid_static_middle.sol',
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/array/calldata_array_as_argument_internal_function.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/array/calldata_array_dynamic_invalid.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/array/calldata_bytes_array_bounds.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/array/calldata_slice_access.sol',
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/array/function_array_cross_calls.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/array/function_memory_array.sol',
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/array/calldata_array_two_dimensional.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/array/create_memory_byte_array.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/array/calldata_array_two_dimensional_1.sol',
  ...
  //---------Built in functions - WillNotSupport most: 4 passing, 1 transcodeError (FixedBytesType)
  ...[
  ...
  //---------Calldata tests: 6 passing, 51 pending, 19 failing, 25 transcodeError (Bytes, FixedBytes, UserDefinedType)
  ...[
    ...
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/calldata/calldata_array_dynamic_bytes.sol',
    ...
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/calldata/copy_from_calldata_removes_bytes_data.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/calldata/calldata_internal_function_pointer.sol',
    ...
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/calldata/calldata_bound_dynamic_array_or_slice.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/calldata/calldata_internal_multi_array.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/calldata/calldata_struct_cleaning.sol', // WILL NOT SUPPORT yul
  ],
  //---------Cleanup tests: 31 passing, 11 pending, 6 failing, 9 transcodeError
  ...[
  ...
  //---------Constant Evaluator: 0 passing, 6 pending, 2 failing
  ...[
  ...
  //---------Constants: 8 passing, 15 pending, 5 failing, 9 transcodeError
  ...[
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/constants/same_constants_different_files.sol',
  ...
  //---------Constructor tests: 19 passing, 50 pending, 19 failing, 11 transcodeError
  ...[
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/constructor/functions_called_by_constructor.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/constructor/constructor_function_argument.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/constructor/constructor_static_array_argument.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/constructor/store_function_in_constructor_packed.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/constructor/no_callvalue_check.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/constructor/constructor_arguments_external.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/constructor/store_internal_unused_library_function_in_constructor.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/constructor/store_function_in_constructor.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/constructor/evm_exceptions_in_constructor_call_fail.sol',
    ...
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/constructor/store_internal_unused_function_in_constructor.sol',
  ...
  //---------Conversions: 0 passing, 3 pending, 1 failing, 1 transcodeError
  ...[
  ...
  //---------Enums tests: 7 passing, 24 pending, 9 failing, 19 transcodeError (UserDefinedType)
  ...[
  ...
  //---------Events tests: 32 passing, 56 pending, 20 failing, 9 transcodeErrors
  ...[
  ...
  //---------Expressions tests: 12 passing, 9 pending, 3 failing
  ...[
  ...
  //---------External contracts tests 0 passing, 18 pending, 6 failing, 40 transcodeError
  ...[
    ...
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/externalContracts/deposit_contract.sol',
  ...
  //---------External source tests - 0 passing, 30 pending, 10 failing
  // TODO investigate transcoding of these tests
  // TODO no pragma
  ...[
  ...
  //---------Fallback tests - Stretch 9 passing, 26 pending, 9 failing, 47 transcodeErrors
  ...[
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/fallback/fallback_override.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/fallback/falback_return.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/fallback/fallback_argument_to_storage.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/fallback/fallback_or_receive.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/fallback/fallback_override2.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/fallback/fallback_override_multi.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/fallback/inherited.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/fallback/fallback_return_data.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/fallback/short_data_calls_fallback.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/fallback/fallback_argument.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/fallback/call_forward_bytes.sol',
  ],
  //---------Free function tests: 20 passing, 10 pending, 7 failing
  // TODO OUT_OF_RESOURCES not successfully flagged as failure
  ...[
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/freeFunctions/free_namesake_contract_function.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/freeFunctions/free_runtimecode.sol',
    ...
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/freeFunctions/import.sol',
  ...
  //---------Function call tests: 70 passing, 31 pending, 15 failing, 2 transcode error
  ...[
    //---------Function call inheritance tests 31 passing, 2 pending, 3 failing
    ...[
    ...
    ...[
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/external_call_to_nonexisting_debugstrings.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/external_call_to_nonexisting.sol',
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/file_level_call_via_module.sol',
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/multiple_functions.sol',
  ...
  //---------Getter tests 28 passing, 15 pending, 5 failing, 17 transcodeErrors
  ...[
    ...
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/getters/value_types.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/getters/mapping_of_string.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/getters/array_mapping_struct.sol',
  ...
  //---------Immutable tests 36 passing, 6 pending, 2 failing, 2 transcode error
  ...[
    ...
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/immutable/getter_call_in_constructor.sol',
  ...
  //---------Inheritance tests 58 passing, 17 pending, 10 failing, 2 transcode error
  ...[
  ...
  //---------isoltest tests: 19 passing, 1 failing, 3 transcode error
  ...[
    ...
    //---------isoltest misc tests: 15 passing, 1 failing, 3 transcode error
    ...[
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/isoltestTesting/account.sol',
  ...
  //---------libraries: 88 passing, 68 passing, 28 failing, 7 transcode error
  ...[
    ...
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/libraries/internal_library_function_bound_to_address_named_send_transfer.sol',
  ...
  //---------literals: 20 assing, 3 pending, 1 failing, 1 transcode errors
  ...[
  ...
  //---------Metatype tests: 1 passing, 2 pending, 1 failing, 3 transcode error
  ...[
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/metaTypes/name_other_contract.sol'
  ],
  //---------Modifiers: 65 passing, 29 pending, 23 failing, 3 transcode error
  ...[
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/modifiers/access_through_contract_name.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/modifiers/access_through_module_name.sol',
  ...
  //---------Operators: 99 passing, 12 pending, 17 failing
  ...[
  ...
  //---------Salted_create - REQUIRES CAIRO 0.9 uses new
  ...[
  ...
  //---------smoke 16 passing, 6 pending, 2 failing, 15 transcode error
  ...[
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/smoke/arrays.sol',
  ...
  //---------state - 3 passing, 1 failing, test suite probably not setting sender address correctly
  ...[
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/msg_sender.sol',
  ...
  //---------Statement tests: 1 passing, 2 pending, 1 failing
  ...[
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/statements/do_while_loop_continue.sol',
  ],
  //---------storage: 26 passing, 29 pending, 13 failing, 16 transcode error
  ...[
  ...
  //---------structs: 68 passing, 107 pending, 51 failing, 34 transcodeError
  ...[
    //---------structs calldata: 28 passing, 34 pending, 14 failing, 21 transcodeError
    ...[
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/calldata/calldata_struct_to_memory_tuple_assignment.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/calldata/calldata_nested_structs.sol',
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/calldata/calldata_struct_with_nested_array_to_storage.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/calldata/calldata_struct_struct_member.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/calldata/calldata_struct_as_memory_argument.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/calldata/dynamically_encoded.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/calldata/calldata_struct_array_member.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/calldata/calldata_struct_as_argument_of_lib_function.sol',
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/calldata/calldata_struct_with_nested_array_to_memory.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/calldata/calldata_struct_array_member_dynamic.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/calldata/dynamic_nested.sol',
    ],
    //---------structs conversion: 0 passing, 6 pending, 2 failing
    ...[
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/conversion/recursive_storage_memory.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/conversion/recursive_storage_memory_complex.sol',
    ],
    //---------structs misc: 40 passing, 67 pending, 25 failing, 13 transcodeError
    ...[
  ...
  //---------types: 66 passing, 45 pending, 17 failing, many transcode errors
  ...[
    ...
    //---------types misc tests: 66 passing, 42 pending, 16 failing, many transcode errors
    ...[
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/types/type_conversion_cleanup.sol',
  ...
  //---------UserDefinedValueType - Not Implemented yet
  ...[
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/userDefinedValueType/storage_signed.sol', // WILL NOT SUPPORT yul
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/userDefinedValueType/ownable.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/userDefinedValueType/in_parenthesis.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/userDefinedValueType/calldata.sol',
    ...
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/userDefinedValueType/erc20.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/userDefinedValueType/conversion_abicoderv1.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/userDefinedValueType/abicodec.sol',
    ...
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/userDefinedValueType/multisource.sol',
    // 'tests/behaviour/solidity/test/libsolidity/semanticTests/userDefinedValueType/multisource_module.sol',
  ...
  //---------Variables: 11 passing, 15 pending, 6 failing, 6 transcode error
  ...[
  ...
  //---------Various tests: 69 passing, 55 pending, 24 failing, 11 transcode errors
  ...[
  ...
  //---------ViaYul: 148 passing, 127 pending, 56 failing, many transcode errors
  ...[
    //---------ViaYul array memory allocation: 13 passing, 5 pending, 2 failing
    ...[
    ...
    //---------ViaYul conversion: 8 passing, 6 pending, 2 failing, 2 transcode error
    ...[
    ...
    //---------ViaYul storage: 4 passing, 3 failing, 1 pending
    ...[
    ...
    //---------ViaYul misc: 107 passing, 116 pending, 49 failing, many transcode errors
    ...[
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/viaYul/empty_return_corrupted_free_memory_pointer.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/viaYul/calldata_array_length.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/viaYul/calldata_array_three_dimensional.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/viaYul/require.sol',
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/viaYul/copy_struct_invalid_ir_bug.sol',
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/viaYul/struct_member_access.sol',
      ...
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/viaYul/calldata_array_access.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/viaYul/array_storage_push_pop.sol',
      // 'tests/behaviour/solidity/test/libsolidity/semanticTests/viaYul/calldata_array_index_range_access.sol',
  ...
  //---------VirtualFunctions: 6 passing, 3 pending, 3 failing
  ...[
