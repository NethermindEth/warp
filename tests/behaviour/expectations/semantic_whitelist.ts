...
export default [
  ...
  //---------Array tests 139 passing, 424 pending, 164 failing
  ...[
    ...
    //-------Array misc tests: 49 passing, 108 pending, 43 failing
    ...[
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/various/codehash.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/various/staticcall_for_view_and_pure_pre_byzantium.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/various/iszero_bnot_correct.sol', WILL NOT SUPPORT yul
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/various/balance.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/various/code_length.sol', WILL NOT SUPPORT yul
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/various/code_length_contract_member.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/various/gasleft_decrease.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/various/value_insane.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/various/address_code.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/various/senders_balance.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/storage/packed_functions.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/modifiers/function_modifier.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/isoltestTesting/balance_other_contract.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/types/external_function_to_address.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/conversions/function_type_array_to_storage.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/immutable/multi_creation.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/immutable/internal_function_pointer.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/inheritance/base_access_to_function_type_variables.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/inheritance/inherited_function_through_dispatch.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/inheritance/address_overload_resolution.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/optimizer/shift_bytes.sol', WILL NOT SUPPORT yul
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionSelector/function_selector_via_contract_name.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/interface_inheritance_conversions.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/viaYul/conversion/function_cast.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/viaYul/function_address.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/viaYul/array_function_pointers.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/viaYul/function_pointers.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/viaYul/delete.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/viaYul/function_selector.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/expressions/uncalled_address_transfer_send.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/blockhash_basic.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/block_gaslimit.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/msg_sender.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/block_coinbase.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/block_basefee.sol', WILL NOT SUPPORT yul
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/tx_origin.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/block_number.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/uncalled_blockhash.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/block_difficulty.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/tx_gasprice.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/msg_data.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/msg_sig.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/gasleft.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/msg_value.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/block_timestamp.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/state/block_chainid.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/libraries/library_delegatecall_guard_view_staticcall.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/libraries/internal_library_function_bound_to_external_function.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/libraries/internal_library_function_bound_to_address.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/libraries/internal_library_function_pointer.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/libraries/internal_library_function_bound_to_function_named_selector.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/libraries/library_address_homestead.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/libraries/external_call_with_function_pointer_parameter.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/libraries/library_address_via_module.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/libraries/internal_library_function_bound_to_internal_function.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/libraries/library_address.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/revertStrings/invalid_abi_decoding_calldata_v1.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/revertStrings/calldata_array_invalid_length.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/revertStrings/calldata_too_short_v1.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/revertStrings/transfer.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/revertStrings/enum_v2.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/revertStrings/library_non_view_call.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/reverts/error_struct.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/copy_from_calldata.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/struct_memory_to_storage_function_ptr.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/multislot_struct_allocation.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/msg_data_to_struct_member_copy.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/struct_storage_to_memory_function_ptr.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/structs/function_type_copy.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/virtualFunctions/internal_virtual_function_calls_through_dispatch.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/literals/escape.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/call_internal_function_via_expression.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/call_function_returning_function.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/gas_and_value_basic.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/failed_create.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/delegatecall_return_value.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/bound_function_in_function.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/call_internal_function_with_multislot_arguments_via_pointer.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/transaction_status.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/calling_nonexisting_contract_throws.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/precompile_extcodesize_check.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/member_accessors.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/value_test.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/gas_and_value_brace_syntax.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/send_zero_ether.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/bound_function_in_var.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/external_call_at_construction_time.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/external_call_value.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/creation_function_call_no_args.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/call_function_returning_nothing_via_pointer.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/creation_function_call_with_salt.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/bare_call_no_returndatacopy.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/calling_uninitialized_function.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/delegatecall_return_value_pre_byzantium.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/functionCall/call_options_overload.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/smoke/basic.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/smoke/fallback.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/smoke/structs.sol',
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/smoke/constructor.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/smoke/alignment.sol',
  ...
  // 'tests/behaviour/solidity/test/libsolidity/semanticTests/constants/function_unreferenced.sol',
