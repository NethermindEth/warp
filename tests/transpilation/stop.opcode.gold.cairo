...
func segment0{
    ...
    return (stack=&newitem3, evm_pc=18, output=Output(0, cast(0, felt*), 0))
end
...
func segment18{
    ...
    if immediate == 0:
        return (stack=stack0, evm_pc=52, output=Output(0, cast(0, felt*), 0))
    end
    ...
    return (stack=&newitem4, evm_pc=19, output=Output(0, cast(0, felt*), 0))
end
...
func segment51{
    ...
    let stack0 = stack
    let (local __fp__, _) = get_fp_and_pc()
    return (stack=stack0, evm_pc=0, output=Output(1, cast(0, felt*), 0))
end
