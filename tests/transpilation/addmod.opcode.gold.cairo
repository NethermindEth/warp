...
from starkware.cairo.common.uint256 import Uint256, uint256_addmod, uint256_eq
...
func segment0{range_check_ptr, msize, memory_dict : DictAccess*}(stack : StackItem*) -> (
    ...
    local newitem0 : StackItem = StackItem(value=Uint256(4911261143028855952388095, 0), next=stack0)
