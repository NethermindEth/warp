...
from starkware.cairo.common.uint256 import Uint256, uint256_eq, uint256_signextend
...
func segment0{range_check_ptr, msize, memory_dict : DictAccess*}(stack : StackItem*) -> (
    ...
    local newitem0 : StackItem = StackItem(value=Uint256(340282366920938463463374607431767015151, 340282366920938463463374607431768211455), next=stack0)
